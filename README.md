...
**كنز طلاب الحاسب** عزيزي المبدع / عزيزتي المبدعة..
بين يديك الآن أكثر من مجرد تجميعة روابط؛ إنه "الرفيق الذكي" الذي سيختصر عليك سنوات من البحث والتشتت. صُمم هذا المرجع بعناية ليكون دليلك الشامل في رحلتك الجامعية والمهنية، حيث يجمع لك عصارة الأدوات والمصادر التي يحتاجها كل تقني طموح ليتحول من مجرد "دارس" إلى "محترف" يشار إليه بالبنان.

✨ ما الذي يجعل هذا الكنز استثنائيًا؟
لقد قمنا بتنظيم كل ما تحتاجه في محطات محددة:

🛠️ ترسانة الأدوات: من التصميم واجهات المستخدم (UI/UX) إلى أحدث برامج الإنتاجية.

💻 ساحات التحدي: منصات عالمية وسعودية لصقل مهاراتك البرمجية وتحويلك إلى "Problem Solver" محترف.

📚 منابع المعرفة: أفضل المنصات التعليمية وقنوات اليوتيوب التي تشرح أعقد المفاهيم بتبسيط مذهل.

💡 خارطة النجاح: نصائح ذهبية في المذاكرة، الاختبارات، وبناء الهوية المهنية (LinkedIn & CV) لتكون الخيار الأول لأرباب العمل.

🤖 عصر الذكاء الاصطناعي: أدوات مبتكرة تضاعف إنتاجيتك وتجعلك تسبق الجميع بخطوات.
...
- [البريد الاحترافي](#البريد-الإحترافي)
...
| الاسم                              | الوصف                                                                                              | الرابط |
| -------------------------------- | ------------------------------------------------------------------------------------------------- | --- |
| المهن في مجالات البيانات والذكاء الاصطناعي | ملف يوضح المسارات الوظيفية في المجال | [PDF](https://drive.google.com/file/d/1ZjuWYpiXtK7oE7LpXwYMjI1PAC1do1-q/view?usp=sharing) |
| تعلم الآلة بالعربي | قائمة تشغيل تشرح مفاهيم تعلم الآلة (Machine Learning) باللغة العربية | [قائمة تشغيل](https://www.youtube.com/watch?v=95RhuC30R5U&list=PLtsZ69x5q-X9j44MdSX-NGuOhGXOY0aqH) |
| Machine Learning Specialization | أشهر كورس لتعلم الآلة من تقديم Andrew Ng على منصة كورسيرا (المدخل الأساسي للمجال) | [Coursera](https://www.coursera.org/specializations/machine-learning-introduction) |
| Deep Learning Specialization | تخصص التعلم العميق المتقدم من DeepLearning.AI | [Coursera](https://www.coursera.org/specializations/deep-learning) |
| Fast.ai | كورس عملي جداً للمبرمجين للدخول في مجال التعلم العميق (Deep Learning) | [Website](https://www.fast.ai/) |
| CS50's Introduction to AI | كورس مقدمة في الذكاء الاصطناعي باستخدام Python من جامعة هارفارد | [Website](https://cs50.harvard.edu/ai/) |
| Hugging Face NLP Course | كورس ممتاز وتطبيقي لفهم معالجة اللغات الطبيعية (NLP) باستخدام المكتبات الحديثة | [Website](https://huggingface.co/learn/nlp-course) |
| Generative AI Learning Path | مسار تعليمي من Google لتعلم الذكاء الاصطناعي التوليدي | [Website](https://www.cloudskillsboost.google/paths/118) |
...
## أدوات ذكاء اصطناعي لتحسين الانتاجية

أدوات ذكاء اصطناعي مبتكرة تساعد الطلاب على التعلم، إدارة الوقت، تلخيص المعلومات، وتحسين الإنتاجية.

| الأداة           | الوصف                                                                                     | الرابط |
|-----------------|------------------------------------------------------------------------------------------|--------|
| **ChatGPT** | مساعد ذكي بالذكاء الاصطناعي يجيب على الأسئلة، يشرح المفاهيم، ويساعد في كتابة الواجبات والمهام الدراسية. | [OpenAI](https://chat.openai.com) |
| **Perplexity AI** | أداة للإجابة عن الأسئلة والبحث بشكل ذكي وسريع، مناسب للبحث الأكاديمي.                  | [Perplexity AI](https://www.perplexity.ai) |
| **Notion AI** | دمج الذكاء الاصطناعي داخل Notion لإنشاء ملاحظات، ملخصات، وخطط دراسية تلقائيًا.       | [Notion AI](https://www.notion.so/product/ai) |
| **ChatPDF** | رفع ملفات PDF والحصول على ملخص أو إجابات عن محتوى المستند بشكل فوري.                  | [ChatPDF](https://www.chatpdf.com) |
| **Quizlet AI** | إنشاء بطاقات تعليمية واختبارات ذكية تلقائيًا باستخدام الذكاء الاصطناعي لتعزيز المذاكرة. | [Quizlet AI](https://quizlet.com/features/ai) |
| **Scholarcy** | أداة تلخيص أوراق البحث والمقالات العلمية بسرعة، تساعد الطلاب على فهم المحتوى العلمي بشكل أسرع. | [Scholarcy](https://www.scholarcy.com) |
| **Mem AI** | مساعد ذكي لتنظيم الملاحظات الشخصية والدراسة، باستخدام الذكاء الاصطناعي لتسهيل استرجاع المعلومات. | [Mem AI](https://mem.ai) |
| **Google Gemini** | أداة مفيدة في دعم المذاكرة؛ حيث يتيح للمستخدم رفع ملفات الدروس أو الملخصات، ثم يساعد في إعداد أسئلة للمراجعة، وتقديم تلخيصات، وشرح النقاط الصعبة | [Google Gemini](https://gemini.google.com/) |
